...
What does OMGene do?
==========
OMGene (Optimise My Gene) aims to improve simultaneously sets of gene models on an orthogroup-by-orthogroup basis. It leverages genetic information from multiple genes across multiple genomes to find most evolutionary consistent set of gene models.
